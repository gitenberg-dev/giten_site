...
"marcrel:adp": ("adapter", set_listable_entity), 
"marcrel:aft": ("author_of_afterword", set_listable_entity), 
"marcrel:ann": ("annotator", set_listable_entity), 
"marcrel:arr": ("arranger", set_listable_entity), 
"marcrel:art": ("artist", set_listable_entity), 
"marcrel:aui": ("author_of_introduction", set_listable_entity), 
"marcrel:clb": ("contributor", set_listable_entity), 
"marcrel:cmm": ("commentator", set_listable_entity), 
"marcrel:cmp": ("composer", set_listable_entity), 
"marcrel:cnd": ("conductor", set_listable_entity), 
"marcrel:com": ("compiler", set_listable_entity), 
"marcrel:ctb": ("contributor", set_listable_entity), 
"marcrel:dub": ("dubious_author", set_listable_entity), 
"marcrel:edt": ("editor", set_listable_entity), 
"marcrel:egr": ("engineer", set_listable_entity), 
"marcrel:ill": ("illustrator", set_listable_entity)  ,
"marcrel:lbt": ("librettist", set_listable_entity), 
"marcrel:oth": ("other_contributor", set_listable_entity), 
"marcrel:pbl": ("publisher_contributor", set_listable_entity), 
"marcrel:pht": ("photographer", set_listable_entity), 
"marcrel:prf": ("performer", set_listable_entity), 
"marcrel:prt": ("printer", set_listable_entity), 
"marcrel:res": ("researcher", set_listable_entity),
"marcrel:trc": ("transcriber", set_listable_entity), 
"marcrel:trl": ("translator", set_listable_entity), 
"marcrel:unk": ("unknown_contributor", set_listable_entity), 
